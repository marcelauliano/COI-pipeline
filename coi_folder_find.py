...
#This script was written to deal with the Sanger Tola assembly team folder structure. It searches for a folder called 'coi' from the path given as first argument "-p" 
