...
parser.add_argument("-out1", help= "output1 is a file that presents a list of directories that contain a folder 'coi'", required = "True")
parser.add_argument("-out2", help= "output1 is a file that presents a list of directories that DOES NOT contain a folder 'coi'", required = "True")
args = parser.parse_args()
output1=open(args.out1, "w")
output2=open(args.out2, "w")
path =[ ]
path2 = [ ]
